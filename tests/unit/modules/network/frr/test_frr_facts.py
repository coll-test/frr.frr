...
class TestFrrFactsModule(TestFrrModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.frr.frr.plugins.modules.frr_facts.run_commands')
        self.run_commands = self.mock_run_commands.start()

        self.mock_get_capabilities = patch('ansible_collections.frr.frr.plugins.modules.frr_facts.get_capabilities')
