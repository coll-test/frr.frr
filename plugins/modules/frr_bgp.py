...
from ansible_collections.frr.frr.plugins.module_utils.network.frr.providers.module import NetworkModule
from ansible_collections.frr.frr.plugins.module_utils.network.frr.providers.cli.config.bgp.process import REDISTRIBUTE_PROTOCOLS
